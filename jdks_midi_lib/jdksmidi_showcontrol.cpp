...
{
    bool f = true;
    e->PutByte ( ( jdks_uchar ) ( GetControlNum() & 0x7f ) );
    e->PutByte ( ( jdks_uchar ) ( ( GetControlNum() >> 7 ) & 0x7f ) );
    e->PutByte ( ( jdks_uchar ) ( GetControlVal() & 0x7f ) );
    e->PutByte ( ( jdks_uchar ) ( ( GetControlVal() >> 7 ) & 0x7f ) );
...
{
    e->PutByte ( ( jdks_uchar ) ( GetMacroNum() ) );
    return true;
}
