...
MIDIParser::MIDIParser ( jdks_ushort max_sysex_size )
{
...
bool MIDIParser::Parse ( jdks_uchar b, MIDIMessage *msg )
{
    ...
    if ( b & 0x80 )
    {
        ...
        //
        jdks_uchar stat = ( jdks_uchar ) ( b & 0xf0 );
...
bool MIDIParser::ParseSystemByte ( jdks_uchar b, MIDIMessage *msg )
{
...
void MIDIParser::ParseStatusByte ( jdks_uchar b )
{
...
bool MIDIParser::ParseDataByte ( jdks_uchar b, MIDIMessage *msg )
{
