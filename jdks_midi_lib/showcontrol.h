...
public:
    ...
    MIDICue ( jdks_ulong v1_ )    : v1 ( v1_ ), num_values ( 1 )   {}
    MIDICue ( jdks_ulong v1_, jdks_ulong v2_ )   : v1 ( v1_ ), v2 ( v2_ ), num_values ( 2 )  {}
    MIDICue ( jdks_ulong v1_, jdks_ulong v2_, jdks_ulong v3_ ) : v1 ( v1_ ), v2 ( v2_ ), v3 ( v3_ ), num_values ( 3 ) {}
    ...
    const MIDICue &operator = ( jdks_ulong v )
    {
        v1 = v;
        num_values = 1;
        return *this;
    ...
    friend MIDICue operator - ( const MIDICue &c, jdks_ulong v );
    friend MIDICue operator - ( jdks_ulong v, const MIDICue &c );
    ...
    jdks_ulong GetNumValues() const
    {
        return num_values;
    }
    jdks_ulong GetV1() const
    {
        return v1;
    }
    jdks_ulong GetV2() const
    {
        return v2;
    }
    jdks_ulong GetV3() const
    {
        return v3;
    }
    ...
    void SetV1 ( jdks_ulong a )
    {
        v1 = a;
    }
    void SetV2 ( jdks_ulong a )
    {
        v2 = a;
    }
    void SetV3 ( jdks_ulong a )
    {
        v3 = a;
    }
protected:
...
inline MIDICue operator - ( const MIDICue &c, jdks_ulong v )
{
    MIDICue result ( c );
    result.v1 -= v;
    return result;
...
inline  MIDICue operator - ( jdks_ulong v, const MIDICue &c )
{
...
public:
    ...
    void Put_TimedGo (
        jdks_uchar hr, jdks_uchar mn, jdks_uchar sc, jdks_uchar fr, jdks_uchar ff
    )
    {
    ...
    void Put_Set ( jdks_ulong ctrl_num, jdks_ulong ctrl_val )
    {
    ...
    void Put_Fire ( jdks_uchar macro_num )
    {
...
protected:
    ...
    bool ParseAsciiNum ( const MIDISystemExclusive *e, int *pos, jdks_ulong *num );
    ...
    _ATTRIBUTE ( jdks_uchar, DeviceId );
    _ATTRIBUTE ( jdks_uchar, CommandFmt );
    ...
    _ATTRIBUTE ( jdks_uchar, Hours );
    _ATTRIBUTE ( jdks_uchar, Minutes );
    _ATTRIBUTE ( jdks_uchar, Seconds );
    _ATTRIBUTE ( jdks_uchar, Frames );
    _ATTRIBUTE ( jdks_uchar, FractFrames );

    _ATTRIBUTE_REF ( MIDICue, QNumber );
    _ATTRIBUTE_REF ( MIDICue, QList );
    _ATTRIBUTE_REF ( MIDICue, QPath );

    _ATTRIBUTE ( jdks_ulong, Val1 );
    _ATTRIBUTE ( jdks_ulong, Val2 );

    _ACCESS ( jdks_ulong, MacroNum, Val1 );
    _ACCESS ( jdks_ulong, ControlNum, Val1 );
    _ACCESS ( jdks_ulong, ControlVal, Val2 );
};
