...
const jdks_uchar smpte_max_frames[] =
{
    24, 25, 30, 30, 30, 30
};
...
void SMPTE::SampleToTime()
{
    ...
    //
    jdks_ulong tmp_sample = sample_number;
    //
    ...
    //
    jdks_uchar max_frame = smpte_max_frames[ smpte_rate ];
    //
    ...
    if ( smpte_rate == SMPTE_RATE_30DF || smpte_rate == SMPTE_RATE_2997DF )
    {
        ...
        tmp_sample += ( jdks_ulong ) ( drops * samples_per_frame );
    ...
    //
    jdks_ulong rounded_sub_frames = ( jdks_ulong ) ( ( tmp_sample * the_smpte_rate * 100 ) / the_sample_rate + .5 );
    DBG ( printf ( "rounded_sub_frames = %ld\n", rounded_sub_frames ) );
    sub_frames = ( jdks_uchar ) ( ( rounded_sub_frames ) % 100 );
    frames     = ( jdks_uchar ) ( ( rounded_sub_frames / 100 ) % max_frame );
    seconds    = ( jdks_uchar ) ( ( rounded_sub_frames / ( 100L * max_frame ) ) % 60 );
    minutes    = ( jdks_uchar ) ( ( rounded_sub_frames / ( 100L * 60L * max_frame ) ) % 60 );
    hours    = ( jdks_uchar ) ( ( rounded_sub_frames / ( 100L * 60L * 24L * max_frame ) ) % 24 );
}
...
void SMPTE::TimeToSample()
{
    ...
    //
    sample_number = ( jdks_ulong ) tmp_sample;
}
...
{
    jdks_ulong a = GetSampleNumber();
    jdks_ulong b = s.GetSampleNumber();
