...
public:
    ...
    void SetSampleNumber ( jdks_ulong n )
    {
        sample_number = n;
        SampleToTime();
    }
    jdks_ulong GetSampleNumber()
    {
    ...
    void SetTime ( jdks_uchar h, jdks_uchar m, jdks_uchar s, jdks_uchar f = 0, jdks_uchar sf = 0 )
    {
        hours = h;
        minutes = m;
        seconds = s;
    ...
    jdks_uchar GetMinutes()
    {
        return minutes;
    }
    jdks_uchar GetSeconds()
    {
        return seconds;
    }
    jdks_uchar  GetFrames()
    {
        return frames;
    }
    jdks_uchar GetSubFrames()
    {
        return sub_frames;
    }

    void SetHours ( jdks_uchar h )
    {
        hours = h;
        sample_number_dirty = true;
    }
    void SetMinutes ( jdks_uchar m )
    {
        minutes = m;
        sample_number_dirty = true;
    }
    void SetSeconds ( jdks_uchar s )
    {
        seconds = s;
        sample_number_dirty = true;
    }
    void SetFrames ( jdks_uchar f )
    {
        frames = f;
        sample_number_dirty = true;
    }
    void SetSubFrames ( jdks_uchar sf )
    {
        sub_frames = sf;
        sample_number_dirty = true;
    }
...
private:
    ...
    jdks_ulong  sample_number;

    jdks_uchar  hours;
    jdks_uchar  minutes;
    jdks_uchar  seconds;
    jdks_uchar  frames;
    jdks_uchar  sub_frames;
    jdks_uchar  sample_number_dirty;
