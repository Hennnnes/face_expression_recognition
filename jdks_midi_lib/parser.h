...
{
public:
    MIDIParser ( jdks_ushort max_sysex_size = 384 );
    virtual  ~MIDIParser();
    ...
    virtual bool Parse ( jdks_uchar b, MIDIMessage *msg );
...
protected:
    ...
    bool ParseSystemByte ( jdks_uchar b, MIDIMessage *msg );
    bool ParseDataByte ( jdks_uchar b, MIDIMessage *msg );
    void ParseStatusByte ( jdks_uchar b );
};
